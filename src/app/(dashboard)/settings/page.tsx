  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-gray-500">Configure your Open Purchase preferences</p>
      </div>
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Use AI for cost analysis and recommendations</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">MiniMax API Key</label>
            <input
              type="password"
              placeholder="sk-..."
              ...
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
            <p className="text-xs text-gray-500 mt-1">Get your API key from console.minimax.chat</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-yellow-700">Demo Mode</h3>
                  <p className="text-sm text-yellow-600">Using mock data. Connect a real database for production.</p>
                </div>
              </div>
            </div>
          </div>
